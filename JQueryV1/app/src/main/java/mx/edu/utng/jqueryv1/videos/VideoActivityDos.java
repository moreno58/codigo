...
public class VideoActivityDos extends ActionBarActivity {
    private WebView view; //membuat variabel view agar bisa akses method onKeyDown

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.actionbar_tab_3_2);

        view = (WebView) this.findViewById(R.id.webView2);
        view.getSettings().setJavaScriptEnabled(true);
        view.setWebViewClient(new MyBrowser());
        view.loadUrl("https://www.youtube.com/watch?v=UVl9fTZ2E58&index=2&list=PLjARR1053fYkOot_mrlBMIggagDYntf-f"); //try js alert
