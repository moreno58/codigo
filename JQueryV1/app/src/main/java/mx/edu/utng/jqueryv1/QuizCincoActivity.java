...
public class QuizCincoActivity extends AppCompatActivity {
        ...
        butNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!(rda.isChecked() || rdb.isChecked() || rdc.isChecked())) {
                    Toast.makeText(QuizCincoActivity.this, "No has contestado la pregunta", Toast.LENGTH_SHORT).show();
                } else {
                    ...
                    if (qid < 30) {
                        ...
                        Intent intent = new Intent(QuizCincoActivity.this, ResultActivity.class);
                        Bundle b = new Bundle();
                ...
                dbcal.actualizarDatos(5, String.valueOf(calificacion));
                dbcal.cerrar();
            }
        });
    }
