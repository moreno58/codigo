        ...
        butNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!(rda.isChecked() || rdb.isChecked() || rdc.isChecked())) {
                    Toast.makeText(QuizTresActivity.this, "No has contestado la pregunta", Toast.LENGTH_SHORT).show();
                } else {
                    ...
                    if (qid < 15) {
                        ...
                        Intent intent = new Intent(QuizTresActivity.this, ResultActivity.class);
                        Bundle b = new Bundle();
                ...
                dbcal.actualizarDatos(3, String.valueOf(calificacion));
                dbcal.cerrar();
            }
        });
    }
