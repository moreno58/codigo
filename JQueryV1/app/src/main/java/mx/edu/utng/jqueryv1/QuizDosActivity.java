        ...
        butNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!(rda.isChecked() || rdb.isChecked() || rdc.isChecked())) {
                    Toast.makeText(QuizDosActivity.this, "No has contestado la pregunta", Toast.LENGTH_SHORT).show();
                } else {
                    ...
                    if (qid < 10) {
                        ...
                        Intent intent = new Intent(QuizDosActivity.this, ResultActivity.class);
                        Bundle b = new Bundle();
                ...
                dbcal.actualizarDatos(2, String.valueOf(calificacion));
                dbcal.cerrar();
            }
        });
    }
