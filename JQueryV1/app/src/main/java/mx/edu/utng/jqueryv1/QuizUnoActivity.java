        ...
        butNext.setOnClickListener(new View.OnClickListener() {
                                       ...
                                       public void onClick(View v) {
                                           ...
                                           if (!(rda.isChecked() || rdb.isChecked() || rdc.isChecked())) {
                                               Toast.makeText(QuizUnoActivity.this, "No has contestado la pregunta", Toast.LENGTH_SHORT).show();
                                           } else {
                                               ...
                                               if (qid < 5) {
                                                   ...
                                                   Intent intent = new Intent(QuizUnoActivity.this, ResultActivity.class);
                                                   Bundle b = new Bundle();
                                           ...
                                           dbcal.actualizarDatos(1, String.valueOf(calificacion));
                                           dbcal.cerrar();
                                       }
                                   }
